...
test_result_df.to_csv('api_final_result.csv', index=False)                                                                  #api_final_result 파일 생성 완료
...
import datetime
stock_data = pd.read_csv('./stock_data(5y).csv', dtype={'Code':str})                                                #주가데이터
...
api_final_result.to_csv('api_final_result.csv', index=False)